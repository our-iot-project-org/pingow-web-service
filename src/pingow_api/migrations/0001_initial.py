# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-09 12:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SHOP_ID', models.IntegerField(null=True)),
                ('CROWD_LEVEL', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High')], default='low', max_length=10, null=True)),
            ],
            options={
                'db_table': 'pg_crowd',
            },
